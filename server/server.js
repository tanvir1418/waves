...
//   useCreateIndex: true,
// }); //  ,{ useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true } is newly added.
    ...
    user.comparePassword(req.body.password, (err, isMatch) => {
      ...
      user.generateToken((err, user) => {
        ...
        res.cookie("w_auth", user.token).status(200).json({
          // cookie is generated from user token. 'w_auth' can be named as we wish such as 'x_auth'
          loginSuccess: true,
        });
      });
    });
